# Generated by Django 2.1.4 on 2018-12-18 04:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Attribute',
            fields=[
                ('uid', models.UUIDField(default=uuid.UUID('94a741bf-c64f-4457-9151-7428289ca411'), editable=False, primary_key=True, serialize=False, verbose_name='Когда создано')),
                ...
                ('rev', models.CharField(default='1-f659d0be-63db-4e20-9549-1fe5adc43d1c', editable=False, max_length=38, verbose_name='Ревизия')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attrs_values', models.ManyToManyField(to='catalog.AttributeValue', verbose_name='Атрибуты')),
                ('created_by', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Кем создано')),
